...
This gem allows for painless integration with ActionMailer and the SendGrid API.
Visit http://sendgrid.com to learn more.
...
Next, update your application's SMTP settings to use SendGrid's servers (see http://wiki.sendgrid.com/doku.php?id=get_started).
...
If you do not already have an ActionMailer class up and running, then check out http://guides.rubyonrails.org/action_mailer_basics.html#walkthrough-to-generating-a-mailer
...
For further explanation see http://wiki.sendgrid.com/doku.php?id=filters
